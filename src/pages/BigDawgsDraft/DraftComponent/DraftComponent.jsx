...
const DraftComponent = () => {
  ...
  useEffect(() => {
    const playerRef = doc(db, "userprofile", currentUser.uid, "auctiondraft", "currentplayer");
  ...
  return (
    <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-850">
      <div className="flex justify-between">
        ...
        <p className="font-semibold text-xl">{player.FullName} ({player.Position})</p>
      ...
      <div className="mt-5 flex gap-10 flex-wrap justify-left">
        <div className=" border-r-1 border-color m-4 pr-10">
          <div className="mt-1">
            ...
            <p className="text-grey-500 text-3xl font-semibold">{player.PositionRank}</p>
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line1}</p>
            <p className="text-green-500 text-3xl font-semibold">{line1Value}</p>
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line2}</p>
            <p className="text-green-500 text-3xl font-semibold">{line2Value}</p>
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line3}</p>
            <p className="text-red-500 text-3xl font-semibold">{line3Value}</p>
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line4}</p>
            <p className="text-green-500 text-3xl font-semibold">{line4Value}</p>
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line5}</p>
            <p className="text-green-500 text-3xl font-semibold">{line5Value}</p>{" "}
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">{line6}</p>
            <p className="text-grey-500 text-3xl font-semibold">{line6Value}</p>{" "}
          </div>
          <div className="mt-1">
            <p className="text-gray-500 mt-1">*NOTE*</p>
